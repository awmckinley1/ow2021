...
\caption{A periodic cosine function (top) made up of a single frequency gives a single 'spike' in the Fourier transform (bottom) at the appropriate frequency.}\label{fig:ch11-ftcosinefunction1}
\end{figure}
