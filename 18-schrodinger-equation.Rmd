...
**Figure to show wavefunctions in a finite well**
...
**Figure to show a potential energy step function**
(\#fig:ch18-reflectionparticlewave1)
...
**Figure to show potential barrier**
(\#fig:ch18-tunelling1)
