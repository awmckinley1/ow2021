...
\draw[->,thick,blue] (axis cs:0,0) -- node[below left]{$A_0$} ++(axis direction cs:{2*cos(-30)},{2*sin(-30)});

\draw[->,thick,blue] (axis cs:{2*cos(-30)},{2*sin(-30)}) -- node[below]{$A_0$} ++(axis direction cs:{2*cos(0)},{2*sin(0)});
\draw[->,thick,blue] (axis cs:{2*cos(-30)+2},{2*sin(-30)}) -- node[below right]{$A_0$} ++(axis direction cs:{2*cos(30)},{2*sin(30)});

\draw[->,thick,orange] (axis cs:0,0) -- node[above]{$A$} ++(axis direction cs:{2*cos(-30)+2*cos(0)+2*cos(30)},{2*sin(-30)+ 2*sin(0)+2*sin(30)});
