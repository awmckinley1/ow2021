...
%	\draw[blue] ({0},{0}) arc (-40:40:0.3);
	...
	\draw[black,<->,thick] (-0.8,0) -- node[left]{$x$} (-0.8,{(\slitsep)/2});
...
\draw[blue,<->] (0,0) -- node[below right]{$L$} ({\distancetoscreen},0);
...
\draw[red,->](0,-{\slitsep/2}) -- ({\distancetoscreen},{\pointP-\slitsep});
\draw[red,densely dotted](0,0) -- ({\distancetoscreen},{\pointP-\slitsep/2});

\draw[blue,<->,thick] ({\distancetoscreen+0.5},0) -- node[right]{$X$} ({\distancetoscreen+0.5},{\pointP-\slitsep/2});
\draw[<->] (0:0.5*\distancetoscreen) arc  (0:8:0.5*\distancetoscreen) node[midway,right]{ $\theta$} ;

\draw[black,densely dotted] (0,{\slitsep/2}) -- ++(-82:1);
\draw[black,densely dotted] (0,{0}) -- ++(-82:1);
\draw[red,-,ultra thick](0,-{\slitsep/2}) -- ++ (8:0.15) node[ right]{$\Delta r$};
