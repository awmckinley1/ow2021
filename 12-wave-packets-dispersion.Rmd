...
**Figure to show dispersion at different times**
(\#fig:ch12-dispersionillustration1)
...
**Figure to show superposition of waves with beat envelope**
(\#fig:ch12-oscillationbeats1)
...
**Figure to show longitudinal and transverse vibrations in 1D lattice**
(\#fig:ch12-phononvibration1)
...
(\#fig:ch12-dispersioncurve1)

From Equation \@ref(eq:ch12-phononvibration2), we can find the group velocity $v_p$ by differentiation:
