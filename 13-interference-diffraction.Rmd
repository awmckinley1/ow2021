...
**Figure of double slit experiment**
(\#fig:ch13-doubleslit1)
...
**Figure of double slit experiment showing angles**
(\#fig:ch13-doubleslit2)
...
**Figure to show $\cos^2$ relationship of fringe intensities**
(\#fig:ch13-cos2fringes)
...
**Figure to show single wide slit**
(\#fig:ch13-singlewideslit1)
...
**Figure to show construction of diffraction from a wide slit**
(\#fig:ch13-singlewideslit2)
...
**Figure to show two wide slits**
(\#fig:ch13-twowideslits1)
...
**Figure to show intensities of diffraction from two wide slits**
(\#fig:ch13-twowideslits2)
...
**Figure to show FT of top-hat function**
...
**Figure to show circular diffraction pattern**
(\#fig:ch13-circulardiffraction1)
...
**Figure to show sources clearly resolved**
(\#fig:ch13-opticalreslimit2)

**Figure to show sources at the resolution limit**
(\#fig:ch13-opticalreslimit3)
